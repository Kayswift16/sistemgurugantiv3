...
const rawData: Record<string, Record<string, string[]>> = {
  ...
  SELASA: {
    "TAHUN 1": ["PH","BM/NS","BM/NS","BI/FS","BI/FS","MT/SD","E","MT/SD","PS/NS","PS/NS",""],
    "TAHUN 2": ["PH","BM/JL","BM/JL","PM/MN","PM/MN","MT/KV","E","MT/KV","BI/FS","BI/FS",""],
    "TAHUN 3": ["PH","BI/BB","BI/BB","PK/NZ","BM/JL","BM/JL","E","BM/JL","PS/SD","PS/SD",""],
    "TAHUN 4": ["PH","MT/IM","MT/IM","RBT/AY","RBT/AY","BM/NS","E","BM/NS","SN/AY","BI/MN","BI/MN",""],
    "TAHUN 5": ["PH","BI/FS","BI/FS","MT/SD","MT/SD","SEJ/AY","E","SEJ/AY","BM/NZ","PM/BB","PM/BB",""],
    "TAHUN 6": ["PH","BM/NZ","BM/NZ","MT/IM","MT/IM","PK/MA","E","BI/BB","BI/BB","SN/MA","SN/MA",""],
  },
  RABU: {
    ...
    "TAHUN 3": ["MT/NS","MT/NS","PM/SD PI/IM","BI/BB","BI/BB","H","BM/JL","PM/SD PI/IM","PM/SD PI/IM","",""],
    "TAHUN 4": ["PJ/NZ","PJ/NZ","BI/MN","SEJ/AY","SEJ/AY","H","PM/SD PI/IM","BM/NS","BM/NS","PK/NZ",""],
    "TAHUN 5": ["PJ/MA","PJ/MA","PM/BB","BI/FS","BI/FS","H","NZ/AY","BM/NZ","BM/NZ","SN/JL",""],
    "TAHUN 6": ["PS/SD","PS/SD","BM/NZ","MT/IM","MT/IM","H","PM/MJ PI/IM","BI/BB","BI/BB","MT/IM",""],
  },
  KHAMIS: {
    ...
    "TAHUN 6": ["BI/BB","BI/BB","SN/MA","RBT/BB","RBT/BB","A","PM/MJ PI/IM","BM/NZ","BM/NZ",""],
  },
  JUMAAT: {
