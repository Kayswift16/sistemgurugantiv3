...
const rawData: Record<string, Record<string, string[]>> = {
  ISNIN: {
    ...
    "TAHUN 4": ["BI/MN","BI/MN","MT/IM","SN/AY","SN/AY","R","BM/NS","BM/NS","PK/NZ","PS/BB","PS/BB",""],
    "TAHUN 5": ["BI/FS","BI/FS","MT/SD","BM/NZ","BM/NZ","R","SN/JL","PM/BB","PM/BB","RBT/AY","RBT/AY",""],
    "TAHUN 6": ["BI/BB","SEJ/AY","SEJ/AY","MT/IM","MT/IM","R","BM/NZ","BM/NZ","MZ/IM","SN/MA","SN/MA",""],
  },
  SELASA: {
    "TAHUN 1": ["PH","BM/NS","BM/NS","BI/FS","BI/FS","E","MT/SD","MT/SD","PS/NS","PS/NS",""],
    "TAHUN 2": ["PH","BM/JL","BM/JL","PM/MN","PM/MN","E","MT/KV","MT/KV","BI/FS","BI/FS",""],
    "TAHUN 3": ["PH","BI/BB","BI/BB","PK/NZ","BM/JL","E","BM/JL","BM/JL","PS/SD","PS/SD",""],
    "TAHUN 4": ["PH","MT/IM","MT/IM","RBT/AY","RBT/AY","E","BM/NS","BM/NS","SN/AY","BI/MN","BI/MN",""],
    "TAHUN 5": ["PH","BI/FS","BI/FS","MT/SD","MT/SD","E","SEJ/AY","SEJ/AY","BM/NZ","PM/BB","PM/BB",""],
    "TAHUN 6": ["PH","BM/NZ","BM/NZ","MT/IM","MT/IM","E","PK/MA","BI/BB","BI/BB","SN/MA","SN/MA",""],
  },
  RABU: {
    "TAHUN 1": ["BI/FS","BI/FS","PM/AY PI/IM","BM/NS","BM/NS","H","BM/NS","MZ/KV","PM/AY PI/IM","PM/AY PI/IM",""],
    "TAHUN 2": ["PM/MN","BM/JL","BM/JL","SN/MA","SN/MA","H","BI/FS","BI/FS","MT/KV","MT/KV",""],
    "TAHUN 3": ["MT/NS","MT/NS","PM/SD PI/IM","BI/BB","BI/BB","H","BM/JL","BM/JL","PM/SD PI/IM","PM/SD PI/IM","",""],
    "TAHUN 4": ["PJ/NZ","PJ/NZ","BI/MN","SEJ/AY","SEJ/AY","H","PM/SD PI/IM","PM/SD PI/IM","BM/NS","BM/NS","MZ/KV",""],
    "TAHUN 5": ["PJ/MA","PJ/MA","PM/BB","BI/FS","BI/FS","H","MZ/AY","BM/NZ","BM/NZ","SN/JL","SN/JL",""],
    "TAHUN 6": ["PS/SD","PS/SD","BM/NZ","MT/IM","MT/IM","H","PM/MJ PI/IM","PM/MJ PI/IM","BI/BB","BI/BB","MT/IM",""],
  },
  KHAMIS: {
    "TAHUN 1": ["BM/NS","BM/NS","PJ/NZ","PJ/NZ","BI/FS","A","SN/AY","SN/AY","MT/SD","MT/SD"],
    "TAHUN 2": ["BI/FS","BI/FS","PJ/IM","PJ/IM","PK/AY","A","PS/FS","PS/FS","BM/JL","BM/JL"],
    "TAHUN 3": ["BM/JL","BM/JL","NZ/SD","SN/KV","SN/KV","A","BI/BB","BI/BB","MT/NS","MT/NS"],
    "TAHUN 4": ["BI/MN","BI/MN","SN/AY","SN/AY","BM/NS","A","PM/SD PI/IM","MT/IM","MT/IM",""],
    "TAHUN 5": ["MT/SD","MT/SD","BI/FS","SN/JL","SN/JL","A","BM/NZ","BM/NZ","PS/AY","PS/AY"],
    "TAHUN 6": ["BI/BB","BI/BB","SN/MA","RBT/BB","RBT/BB","A","PM/MJ PI/IM","PM/MJ PI/IM","BM/NZ","BM/NZ",""],
  },
  JUMAAT: {
    "TAHUN 1": ["BI/FS","BI/FS","SN/AY","SN/AY","MT/SD","T","BM/NS","BM/NS","",""],
    "TAHUN 2": ["BM/JL","BM/JL","MT/KV","BI/FS","NZ/IM","T","SN/MA","SN/MA","",""],
    "TAHUN 3": ["BI/BB","PJ/NZ","PJ/NZ","MT/NS","MT/NS","T","BM/JL","BM/JL","",""],
    "TAHUN 4": ["BM/NS","BM/NS","PM/SD PI/IM","BI/MN","BI/MN","T","MT/IM","MT/IM","",""],
    "TAHUN 5": ["MT/SD","MT/SD","PK/MA","BM/NZ","BM/NZ","T","BI/FS","BI/FS","",""],
    "TAHUN 6": ["PJ/MA","PJ/MA","PM/MJ PI/IM","BI/BB","BI/BB","T","BM/NZ","BM/NZ","",""],
  },
};
